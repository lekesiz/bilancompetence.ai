...
// Create update schema without refinements, then make it partial
const baseAvailabilitySlotSchema = z.object({
...
export const updateAvailabilitySlotSchema = baseAvailabilitySlotSchema;
