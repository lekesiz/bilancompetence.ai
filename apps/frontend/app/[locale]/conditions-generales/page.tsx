        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 md:p-12">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-4">Article 1 - Définitions</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-4">Article 2 - Objet</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-4">Article 3 - Accès à la Plateforme</h2>
              
              <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-3">3.1. Inscription</h3>
              <p className="text-gray-700 dark:text-gray-200 mb-4">
                L'accès aux services nécessite la création d'un compte utilisateur. Lors de l'inscription, vous vous engagez à :
              </p>
              <ul className="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-200 mb-4 ml-4">
              ...
              <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-3">3.2. Disponibilité</h3>
              <p className="text-gray-700 dark:text-gray-200 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-4">Article 4 - Description des Services</h2>
              
              <div className="bg-gradient-to-r from-purple-50 to-blue-50 p-6 rounded-lg mb-4">
                <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-3">4.1. Bilan de Compétences</h3>
                <p className="text-gray-700 dark:text-gray-200 mb-4">
                  Le bilan de compétences comprend trois phases obligatoires :
                </p>
                <div className="space-y-4">
                  <div className="bg-white dark:bg-gray-800 p-4 rounded-lg">
                    <h4 className="font-semibold text-gray-800 dark:text-gray-100 mb-2">Phase Préliminaire (4-6 heures)</h4>
                    <ul className="list-disc list-inside space-y-1 text-gray-700 dark:text-gray-200 text-sm">
                  ...
                  <div className="bg-white dark:bg-gray-800 p-4 rounded-lg">
                    <h4 className="font-semibold text-gray-800 dark:text-gray-100 mb-2">Phase d'Investigation (12-16 heures)</h4>
                    <ul className="list-disc list-inside space-y-1 text-gray-700 dark:text-gray-200 text-sm">
                  ...
                  <div className="bg-white dark:bg-gray-800 p-4 rounded-lg">
                    <h4 className="font-semibold text-gray-800 dark:text-gray-100 mb-2">Phase de Conclusion (4-6 heures)</h4>
                    <ul className="list-disc list-inside space-y-1 text-gray-700 dark:text-gray-200 text-sm">
              ...
              <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-3">4.2. Durée</h3>
              <p className="text-gray-700 dark:text-gray-200 mb-4">
                La durée totale du bilan de compétences est de 24 heures minimum, réparties sur une période de 2 à 3 mois maximum.
              </p>

              <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-3">4.3. Modalités</h3>
              <p className="text-gray-700 dark:text-gray-200 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-4">Article 5 - Tarifs et Paiement</h2>
              
              <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-3">5.1. Tarifs</h3>
              ...
              <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-3">5.2. Modalités de Paiement</h3>
              <p className="text-gray-700 dark:text-gray-200 mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-3">5.3. Facturation</h3>
              <p className="text-gray-700 dark:text-gray-200 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-4">Article 6 - Droit de Rétractation</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-4">Article 7 - Annulation et Report</h2>
              
              <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-3">7.1. Annulation par le Bénéficiaire</h3>
              <div className="bg-blue-50 p-6 rounded-lg mb-4">
                <ul className="space-y-2 text-gray-700 dark:text-gray-200">
              ...
              <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-3">7.2. Report de Rendez-vous</h3>
              <p className="text-gray-700 dark:text-gray-200 mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-3">7.3. Annulation par Netz Informatique</h3>
              <p className="text-gray-700 dark:text-gray-200 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-4">Article 8 - Obligations du Bénéficiaire</h2>
              <p className="text-gray-700 dark:text-gray-200 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-4">Article 9 - Obligations de Netz Informatique</h2>
              <p className="text-gray-700 dark:text-gray-200 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-4">Article 10 - Confidentialité</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-4">Article 11 - Propriété Intellectuelle</h2>
              <p className="text-gray-700 dark:text-gray-200 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-4">Article 12 - Responsabilité</h2>
              
              <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-3">12.1. Responsabilité de Netz Informatique</h3>
              <p className="text-gray-700 dark:text-gray-200 mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-3">12.2. Assurance</h3>
              <p className="text-gray-700 dark:text-gray-200 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-4">Article 13 - Réclamations et Médiation</h2>
              
              <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-3">13.1. Réclamations</h3>
              <p className="text-gray-700 dark:text-gray-200 mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-3">13.2. Médiation de la Consommation</h3>
              <div className="bg-green-50 p-6 rounded-lg">
                ...
                <p className="text-gray-700 dark:text-gray-200 mb-2"><strong>Médiateur de la Consommation :</strong> [Nom du médiateur]</p>
                <p className="text-gray-700 dark:text-gray-200 mb-2"><strong>Adresse :</strong> [Adresse]</p>
                <p className="text-gray-700 dark:text-gray-200 mb-2"><strong>Site web :</strong> [URL]</p>
                <p className="text-gray-700 dark:text-gray-200"><strong>Email :</strong> [Email]</p>
              </div>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-4">Article 14 - Protection des Données Personnelles</h2>
              <p className="text-gray-700 dark:text-gray-200 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-4">Article 15 - Force Majeure</h2>
              <p className="text-gray-700 dark:text-gray-200 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-4">Article 16 - Modification des CGU-CGV</h2>
              <p className="text-gray-700 dark:text-gray-200 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-4">Article 17 - Droit Applicable et Juridiction</h2>
              <p className="text-gray-700 dark:text-gray-200 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-4">Article 18 - Acceptation des CGU-CGV</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-4">Article 19 - Contact</h2>
              <div className="bg-blue-50 p-6 rounded-lg">
                <p className="text-gray-700 dark:text-gray-200 mb-4">
