    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-600 via-secondary-600 to-secondary-700 flex items-center justify-center py-12 px-4">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <Card variant="default" className="p-8">
          ...
          {/* Login Link */}
          <Link href="/fr/login" className="block">
            <button className="w-full px-6 py-3 border-2 border-primary-600 text-primary-600 rounded-xl font-semibold hover:bg-primary-50 transition-all flex items-center justify-center gap-2">
              {t('loginButton')}
