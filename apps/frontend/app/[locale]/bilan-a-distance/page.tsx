    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-800">
      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        ...
        <div className="mb-16">
          ...
          <p className="text-xl text-gray-700 dark:text-gray-200 text-center max-w-4xl mx-auto mb-12">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Flexibilité totale</h3>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Même qualité</h3>
              <p className="text-gray-600 dark:text-gray-300">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Outils digitaux</h3>
              <p className="text-gray-600 dark:text-gray-300">
        ...
        {/* How it works */}
        <div className="mb-16 bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-12">
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-start">
              ...
              <div className="flex-1">
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Inscription en ligne</h3>
            ...
            <div className="flex items-start">
              ...
              <div className="flex-1">
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Premier rendez-vous par visioconférence</h3>
                <p className="text-gray-700 dark:text-gray-200 mb-4">
            ...
            <div className="flex items-start">
              ...
              <div className="flex-1">
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Tests et travaux personnels</h3>
                <p className="text-gray-700 dark:text-gray-200 mb-4">
            ...
            <div className="flex items-start">
              ...
              <div className="flex-1">
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Entretiens de suivi réguliers</h3>
                <p className="text-gray-700 dark:text-gray-200 mb-4">
            ...
            <div className="flex items-start">
              ...
              <div className="flex-1">
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Synthèse et plan d'action</h3>
                <p className="text-gray-700 dark:text-gray-200 mb-4">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-8">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white">Plateforme sécurisée</h3>
              </div>
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span className="text-gray-700 dark:text-gray-200">Accès 24/7 à vos documents et tests</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-success-600 mr-2 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-gray-700 dark:text-gray-200">Suivi de progression en temps réel</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-success-600 mr-2 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-gray-700 dark:text-gray-200">Messagerie sécurisée avec votre consultant</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-success-600 mr-2 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-gray-700 dark:text-gray-200">Données cryptées et conformité RGPD</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-2xl p-8">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white">Visioconférence HD</h3>
              </div>
              <ul className="space-y-3">
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-success-600 mr-2 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span className="text-gray-700 dark:text-gray-200">Qualité vidéo et audio professionnelle</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-success-600 mr-2 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-gray-700 dark:text-gray-200">Partage d'écran pour les exercices</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-success-600 mr-2 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-gray-700 dark:text-gray-200">Compatible tous appareils (PC, tablette, mobile)</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-success-600 mr-2 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-gray-700 dark:text-gray-200">Enregistrement des séances (sur demande)</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl p-8">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white">Intelligence Artificielle</h3>
              </div>
              <ul className="space-y-3">
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-success-600 mr-2 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span className="text-gray-700 dark:text-gray-200">Analyse automatique de votre CV</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-success-600 mr-2 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-gray-700 dark:text-gray-200">Recommandations métiers personnalisées</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-success-600 mr-2 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-gray-700 dark:text-gray-200">Génération de plan d'action intelligent</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-success-600 mr-2 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-gray-700 dark:text-gray-200">Matching avec formations adaptées</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-2xl p-8">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white">Tests psychométriques</h3>
              </div>
              <ul className="space-y-3">
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-success-600 mr-2 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span className="text-gray-700 dark:text-gray-200">MBTI (personnalité professionnelle)</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-success-600 mr-2 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-gray-700 dark:text-gray-200">RIASEC (intérêts professionnels)</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-success-600 mr-2 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-gray-700 dark:text-gray-200">Inventaire de compétences</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-success-600 mr-2 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-gray-700 dark:text-gray-200">Test de valeurs professionnelles</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl p-12 text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link 
              href="/register"
              className="px-10 py-5 bg-white dark:bg-gray-800 text-blue-700 rounded-lg font-bold text-lg hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 shadow-2xl"
            >
