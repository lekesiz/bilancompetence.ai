        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 md:p-12">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-4">1. Responsable du Traitement</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-4">2. Données Collectées</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-4">3. Finalités du Traitement</h2>
              <p className="text-gray-700 dark:text-gray-200 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-4">4. Base Légale du Traitement</h2>
              <p className="text-gray-700 dark:text-gray-200 mb-4">
                Conformément au RGPD, le traitement de vos données repose sur les bases légales suivantes :
              </p>
              <div className="space-y-3">
                <div className="bg-green-50 p-4 rounded-lg">
                  <p className="font-semibold text-gray-800 dark:text-gray-100 mb-2">Exécution du contrat</p>
                  <p className="text-gray-700 dark:text-gray-200">Le traitement est nécessaire à l'exécution du contrat de bilan de compétences.</p>
                </div>
                <div className="bg-green-50 p-4 rounded-lg">
                  <p className="font-semibold text-gray-800 dark:text-gray-100 mb-2">Consentement</p>
                  <p className="text-gray-700 dark:text-gray-200">Vous avez donné votre consentement explicite pour certains traitements (newsletters, cookies non essentiels).</p>
                </div>
                <div className="bg-green-50 p-4 rounded-lg">
                  <p className="font-semibold text-gray-800 dark:text-gray-100 mb-2">Obligation légale</p>
                  <p className="text-gray-700 dark:text-gray-200">Le traitement est nécessaire au respect d'obligations légales (comptabilité, certification Qualiopi).</p>
                </div>
                <div className="bg-green-50 p-4 rounded-lg">
                  <p className="font-semibold text-gray-800 dark:text-gray-100 mb-2">Intérêt légitime</p>
                  <p className="text-gray-700 dark:text-gray-200">Le traitement est nécessaire aux fins de nos intérêts légitimes (amélioration des services, sécurité).</p>
                </div>
              </div>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-4">5. Destinataires des Données</h2>
              <p className="text-gray-700 dark:text-gray-200 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-4">6. Transferts de Données hors UE</h2>
              <p className="text-gray-700 dark:text-gray-200 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-4">7. Durée de Conservation</h2>
              <p className="text-gray-700 dark:text-gray-200 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-4">8. Vos Droits</h2>
              <p className="text-gray-700 dark:text-gray-200 mb-4">
                Conformément au RGPD, vous disposez des droits suivants sur vos données personnelles :
              </p>
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-blue-50 p-4 rounded-lg">
                  <h3 className="font-semibold text-gray-800 dark:text-gray-100 mb-2">✓ Droit d'accès</h3>
                  <p className="text-sm text-gray-700 dark:text-gray-200">Obtenir une copie de vos données personnelles</p>
                </div>
                <div className="bg-blue-50 p-4 rounded-lg">
                  <h3 className="font-semibold text-gray-800 dark:text-gray-100 mb-2">✓ Droit de rectification</h3>
                  <p className="text-sm text-gray-700 dark:text-gray-200">Corriger vos données inexactes ou incomplètes</p>
                </div>
                <div className="bg-blue-50 p-4 rounded-lg">
                  <h3 className="font-semibold text-gray-800 dark:text-gray-100 mb-2">✓ Droit à l'effacement</h3>
                  <p className="text-sm text-gray-700 dark:text-gray-200">Demander la suppression de vos données (sous conditions)</p>
                </div>
                <div className="bg-blue-50 p-4 rounded-lg">
                  <h3 className="font-semibold text-gray-800 dark:text-gray-100 mb-2">✓ Droit à la limitation</h3>
                  <p className="text-sm text-gray-700 dark:text-gray-200">Limiter le traitement de vos données</p>
                </div>
                <div className="bg-blue-50 p-4 rounded-lg">
                  <h3 className="font-semibold text-gray-800 dark:text-gray-100 mb-2">✓ Droit à la portabilité</h3>
                  <p className="text-sm text-gray-700 dark:text-gray-200">Recevoir vos données dans un format structuré</p>
                </div>
                <div className="bg-blue-50 p-4 rounded-lg">
                  <h3 className="font-semibold text-gray-800 dark:text-gray-100 mb-2">✓ Droit d'opposition</h3>
                  <p className="text-sm text-gray-700 dark:text-gray-200">Vous opposer au traitement de vos données</p>
                </div>
                <div className="bg-blue-50 p-4 rounded-lg">
                  <h3 className="font-semibold text-gray-800 dark:text-gray-100 mb-2">✓ Droit de retrait du consentement</h3>
                  <p className="text-sm text-gray-700 dark:text-gray-200">Retirer votre consentement à tout moment</p>
                </div>
                <div className="bg-blue-50 p-4 rounded-lg">
                  <h3 className="font-semibold text-gray-800 dark:text-gray-100 mb-2">✓ Droit de réclamation</h3>
                  <p className="text-sm text-gray-700 dark:text-gray-200">Déposer une plainte auprès de la CNIL</p>
                </div>
              </div>

              <div className="bg-gradient-to-r from-purple-100 to-blue-100 p-6 rounded-lg mt-6">
                <h3 className="font-semibold text-gray-800 dark:text-gray-100 mb-3">Comment exercer vos droits ?</h3>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-4">9. Sécurité des Données</h2>
              <p className="text-gray-700 dark:text-gray-200 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-4">10. Cookies et Traceurs</h2>
              <p className="text-gray-700 dark:text-gray-200 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-4">11. Modifications de la Politique</h2>
              <p className="text-gray-700 dark:text-gray-200 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-4">12. Contact</h2>
              <div className="bg-gradient-to-r from-purple-50 to-blue-50 p-6 rounded-lg">
                <p className="text-gray-700 dark:text-gray-200 mb-4">
