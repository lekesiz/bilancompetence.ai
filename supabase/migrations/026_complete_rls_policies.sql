-- ============================================================================
-- MIGRATION 026: COMPLETE RLS POLICIES FOR ALL TABLES
-- Date: 2025-10-25
...
-- Politique INSERT: Seuls les admins peuvent créer des utilisateurs (après registration initiale)
...
-- Politique DELETE: Seuls les admins peuvent supprimer (soft delete via deleted_at)
...
-- Politique INSERT: Seuls les admins peuvent créer des organisations
...
-- ============================================================================
-- 14. AVAILABILITY_SLOTS - Peut rester public (consultants publient leurs dispos)
-- ============================================================================

-- Option 1: Laisser public (pas de RLS)
-- Option 2: Activer RLS avec politique publique
...
ON session_reminders
FOR INSERT
WITH CHECK (true); -- Système backend peut créer
